package com.lyf.scrollflags.flutter
...
class FlutterFragment : Fragment() {
    ...
    private var mAdapter: FlutterAdapter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val flutterList = resources.getStringArray(R.array.flutter_names).toList()
        mAdapter = FlutterAdapter(flutterList)
